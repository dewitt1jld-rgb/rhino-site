          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="max-width:680px;background:#0b1220;border:1px solid #3f2f12;border-radius:24px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:10px 28px 0;">
                <div style="background:#111827;border:1px solid #263244;border-radius:20px;padding:24px;">
                  <h2 style="margin:0 0 18px;color:#ffffff;font-size:22px;text-align:center;">
                    A Message From The Rhino Wrangler
                  </h2>
                  ...
                  <div style="text-align:center;padding:8px 0 20px;">
                    <img
                      src="${portraitUrl}"
                      alt="Landon DeWitt"
                      style="width:160px;height:160px;object-fit:cover;border-radius:20px;border:1px solid #f59e0b;display:block;margin:0 auto 14px;"
                    />
                  ...
                  <p style="margin:0 0 14px;color:#d1d5db;font-size:15px;line-height:1.8;">
            ...
            <tr>
              <td style="padding:22px 28px 0;">
                <div style="background:#111827;border:1px solid #f59e0b;border-radius:20px;padding:24px;">
                  <h2 style="margin:0 0 12px;color:#ffffff;font-size:22px;">
                    Company-Wide Access
                  </h2>
            ...
            <tr>
              <td style="padding:0 28px 22px;">
                <div style="background:#111827;border:1px solid #263244;border-radius:20px;padding:22px;">
                  <h2 style="margin:0 0 12px;color:#ffffff;font-size:20px;">
                    Need Help?
                  </h2>
                  ...
                  <p style="margin:14px 0 0;">
                    <a href="${contactUrl}" style="color:#f59e0b;font-weight:800;text-decoration:none;">
            ...
            <tr>
              <td style="padding:0 28px 28px;">
                <div style="border-top:1px solid #263244;padding-top:22px;">
                  ...
                  <p style="margin:18px 0 0;color:#d1d5db;font-size:14px;line-height:1.7;">
                    Thank you again for your support,<br />
                    <strong style="color:#ffffff;">Landon DeWitt</strong><br />
                    The Rhino Wrangler
                  </p>

                  <p style="margin:18px 0 0;color:#9ca3af;font-size:13px;line-height:1.7;">
