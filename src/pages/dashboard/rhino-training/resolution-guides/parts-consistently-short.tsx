...
export default function PartsConsistentlyShortPage() {
  return (
    <RequireActiveAccess>
      <TrainingLayout>
        <div className="breadcrumb">
          Rhino Training / Resolution Guides / Parts Consistently Short
        </div>

        <section className="heroPanel">
          <p className="eyebrow">Resolution Guide 01</p>

          <h1>How to Fix Parts That Are Consistently Short</h1>

          <p>
            Use this guide when all finished parts are consistently shorter
        ...
        <section className="panel">
          <div className="panelHeader">
            <h2>Faster Method — Manually Increase Saw Kerf</h2>
          ...
          <div className="panelContent">
            ...
            <div className="stepList">
              ...
              <Step number={5}>
                ...
                <strong>
                  ADD the amount the finished parts are consistently short by.
                </strong>
              </Step>
            ...
            <div className="example">
              ...
              1/32&quot; short, increase the existing Saw Kerf value by
              1/32&quot;.
            </div>
          </div>
        </section>
